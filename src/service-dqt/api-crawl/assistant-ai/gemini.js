...
const geminiApiKey = "AIzaSyAmKDXQWy0G0HACTgTMIa5wW0RMQgePav4";
...
export function initGeminiModel() {
  ...
  const systemInstruction = `Bạn tên là Tân Đoàn Dev
Bạn được tạo ra bởi duy nhất Tân Đoàn Dev
Mọi Câu Hỏi Đều Sẽ Có Cấu Trúc [Tên Người Hỏi: Câu Hỏi]
Nếu tên người hỏi là Tân Đoàn thì bạn sẽ nhận họ là Đại Ca
